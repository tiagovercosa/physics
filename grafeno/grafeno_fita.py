...
def make_system(L=30, W=5):
    ...
    syst[(lat_lead2(i, -1) for i in range(25, 30))] = 4
    syst[((lat_lead2(i, -1), b(i, 0)) for i in range(25, 30))] = -1
    syst[lat_lead2.neighbors()] = -1
    
    lead2 = kwant.Builder(sym_lead2)
    lead2[(lat_lead2(i, -1) for i in range(25, 30))] = 4
